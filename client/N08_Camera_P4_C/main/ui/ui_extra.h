...
// Configurações otimizadas para ambiente agrícola (céu aberto)
// Baseado em: CONFIGURACOES_CAMERA_ALVOS.md - ambiente outdoor
#define DEFAULT_CONTRAST_PERCENT 78     // Alto contraste para destacar detalhes em campo aberto
#define DEFAULT_SATURATION_PERCENT 52   // Reduzida para evitar oversaturação com iluminação solar intensa
#define DEFAULT_BRIGHTNESS_PERCENT 62   // Aumentado para compensar variações de sombra e luz solar
#define DEFAULT_HUE_PERCENT 0           // Neutro - ideal para condições de luz natural variável
// Exposure: 0% = 500us (1/2000s), 50% = 2250us (1/444s), 100% = 4000us (1/250s)
#define DEFAULT_EXPOSURE_PERCENT 18     // ~1130us (1/885s) - ideal para sol moderado em campo aberto
